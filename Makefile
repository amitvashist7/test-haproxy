...
integration_test:build
	...
	docker run -d --name lb0 --link web-a:web-a --link web-b:web-b -p 8000:80 haproxy
	...
	docker run -d --name lb1 --link web-a:web-a -e DEFAULT_SSL_CERT="$(cert0)" -p 442:443 haproxy
	sleep 5
	...
	docker run -d --name lb2 --link web-c:web-c --link web-d:web-d -p 8002:80 haproxy
	...
	docker run -d --name lb3 --link web-e:web-e -p 8003:80 haproxy
	...
	docker run -d --name lb4 --link web-f:web-f -p 8004:80 haproxy
	...
	docker run -d --name lb5 --link web-g:web-g --link web-h:web-h --link web-i:web-i --link web-j:web-j --link web-k:web-k --link web-l:web-l --link web-m:web-m -p 8005:80 haproxy
	...
	docker run -d --name lb6 --link web-n:web-n -p 8006:80 haproxy
	...
	docker run -d --name lb7  --link web-o:web-o --link web-p:web-p -p 8007:443 haproxy
	sleep 5
	...
	docker run -d --name lb8  --link web-q:web-q --link web-r:web-r --link web-s:web-s -p 443:443 -p 444:444 -p 8008:8008 -p 8009:8009 -p 80:80 -p 8011:8011 haproxy
	sleep 5
